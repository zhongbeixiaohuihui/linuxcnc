...
void InitSocketModbusMaster ()
{
    ...
    Error  = pthread_create (&thread_socket_client, NULL, (void * (*) (void *)) SocketModbusMasterLoop,
                                      (void *) NULL);
...
int WaitRespSocketModbusMaster (char * Buff, int BuffSize, int TimeOutResponseMilliSecs)
{
    ...
    if (recep_descrip > 0)
    {
        ...
        if (ModbusDebugLevel >= 2)
        {
            printf ("INFO CLASSICLADDER-	 waiting for slave response...\n");
        }
        ...
        else
        {
            ...
            if (SizeQuestionToAsk > 0)
            {
                ...
                else
                {
                    ...
                    SerialSetResponseSize (1 /*adr*/ +GetModbusResponseLenghtToReceive () + 2 /*crc
                                                                                                                    */
