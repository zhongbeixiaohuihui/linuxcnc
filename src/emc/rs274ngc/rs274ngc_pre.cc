...
Side Effects:
   Calls to canonical machining commands are made. ���ù淶�ӹ�����
   The interpreter variables are changed. �����������Ѹ���
   At the end of the program, the file is closed. ������� �ļ��ر�
   If using a file, the active G codes and M codes are updated.  ���ʹ���ļ� ���¼���̬GM����
